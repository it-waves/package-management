...
```sh
sudo wget https://binaries.sonarsource.com/Distribution/sonarqube/sonarqube-9.5.zip
sudo unzip sonarqube-9.5.zip
sudo rm -rf sonarqube-9.5.zip
sudo mv sonarqube-9.5 sonarqube
```
